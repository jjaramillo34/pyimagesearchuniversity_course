# USAGE
# python basic_drawing_practice.py
...
# draw a green 50X50 pixel square, starting at 10x10 end ending at 60x60
cv2.rectangle(canvas, (10,10), (60, 60), green)
cv2.imshow("Canvas", canvas)
cv2.waitKey(0)

# draw another rectangle. this one red 5 pixel thickness
...
blue = (255, 0, 0)
cv2.rectangle(canvas, (200, 50), (22, 125), blue, -1)
cv2.imshow("Camvas", canvas)
cv2.waitKey(0)

# re-initialize our canvas as an empty array, them compute the
# center (x, y)-coordinates of the canvas
canvas = np.zeros((300, 300, 3), dtype="uint8")
(centerX, centerY) = (canvas.shape[1] // 2, canvas.shape[0] // 2)
white = (255, 255, 255)

# loop over increasing radii, from 25 pixels to 150 pixels in 25 pixels increments
...
for i in range(0, 25):
    # randomly generate a radius size between 5 to 200, generate a
