# USAGE
# python opencv_bitwise_practice.py
...
# a bitwise "AND" is only 'True' when both inputs have a value that in "ON" -- in
# this case, the cv2.bitwise_and function examines every pixel in the rectangle
# and circle; if *BOTH* pixels have a value greater than zero then the pixel is
# turned 'ON' (i.e., 255) in the output image; otherwise, the output value is set
# to 'OFF' (i.e., 0)
