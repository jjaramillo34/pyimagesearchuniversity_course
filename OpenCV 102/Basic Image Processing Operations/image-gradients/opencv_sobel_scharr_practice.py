...
# if you need to use sharr kernel
...
# set the kernel size, depending on whether we are using the Sobel operator 
# of the Scharr operator, then compute the gradients along the x and y 
# axis respectively
