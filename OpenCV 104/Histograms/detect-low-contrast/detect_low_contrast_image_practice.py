# USAGE
# python detect_low_contrast_image_practice.py --input examples
...
for (i, imagePath) in enumerate(imagePaths):
    ...
    # initialize the text and color to indicate that the input image is 
    # *not* low contrast
    ...
    # otherwise, the image is *not* low contrast, so we can continue processing
    # it
    else:
        # find contours in the edge map and find the largest one, which we'll 
        # assume is tge outline of our color correction card
    ...
    # show the ouput image and edge map
