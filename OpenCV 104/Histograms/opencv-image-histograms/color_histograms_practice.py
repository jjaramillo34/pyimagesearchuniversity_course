# USAGE
# python color_histograms_practice.py --image beach.png
...
# split the image into its respective channels, the initialize the tuple of 
# channel names with our figure for plotting
chans = cv2.split(image)
colors = ["b", "g", "r"]
plt.figure()
plt.title("Flattened Color Histrogram")
plt.xlabel("Bins")
