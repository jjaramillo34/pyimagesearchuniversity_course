# USAGE
# python adaptive_equalization_practice.py --image images/boston.png
...
# apply CLAHE (Contrast Limited Adaptive Histrogram Equalization)
print("[INFO] applying CLANE...")
