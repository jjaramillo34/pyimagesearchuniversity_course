# USAGE
# python detect_aruco_image_practice.py --image images/example_01.png --type DICT_5X5_100
...
# load the inut image from disk and resize it
...
if len(corners) > 0:
    ...
    for (markerCorner, markerID) in zip(corners, ids):
        ...
        cv2.putText(image, str(markerID),
            ...
            0.5, (0, 255, 0), 2)
        print("[INFO] ArUco mrker ID: {}".format(markerID))
